...
namespace BesterUI
{
    public static class NewFeatureCreator
    {
    ...
    #region DataSlicing
        public static List<DataReading> GeneralDataSlice(List<DataReading> data, int startTime, int endTime)
        {
            return data.SkipWhile(x => x.timestamp < startTime).TakeWhile(x => x.timestamp < endTime).ToList();
        }
        #endregion
        ...
        static void PopulateEEG()
        {
            ...
            foreach (string name in names)
            {
                ...
                EEGArousalOptimizationFeatures.Add(new Feature("EEG DASM AF3-AF4",
                    ...
                    DASM(GeneralDataSlice(data, startTime, endTime), name,
        ...
        {
            //Arousal
            HRArousalOptimizationFeatures.Add(new Feature("HR Mean IBI", (data, startTime, endTime) => IBIMean(GeneralDataSlice(data, startTime, endTime))));
            HRArousalOptimizationFeatures.Add(new Feature("HR stdev IBI", (data, startTime, endTime) => IBISD(GeneralDataSlice(data, startTime, endTime))));
            HRArousalOptimizationFeatures.Add(new Feature("HRV RMSSD", (data, startTime, endTime) => HRVRMSSD(GeneralDataSlice(data, startTime, endTime))));


            //Valence
            HRValenceOptimizationFeatures.Add(new Feature("HR Mean IBI", (data, startTime, endTime) => IBIMean(GeneralDataSlice(data, startTime, endTime))));
            HRValenceOptimizationFeatures.Add(new Feature("HR stdev IBI", (data, startTime, endTime) => IBISD(GeneralDataSlice(data, startTime, endTime))));
            HRValenceOptimizationFeatures.Add(new Feature("HRV RMSSD", (data, startTime, endTime) => HRVRMSSD(GeneralDataSlice(data, startTime, endTime))));
            HRValenceOptimizationFeatures.Add(new Feature("HR Mean", (data, startTime, endTime) => Mean(GeneralDataSlice(data, startTime, endTime), HRValueAccessor)));
            HRValenceOptimizationFeatures.Add(new Feature("HR Max", (data, startTime, endTime) => Max(GeneralDataSlice(data, startTime, endTime), HRValueAccessor)));
        ...
        {
            //Arousal
            GSRArousalOptimizationFeatures.Add(new Feature("GSR Mean", (data, startTime, endTime) => Mean(GeneralDataSlice(data, startTime, endTime), GSRValueAccessor)));
            GSRArousalOptimizationFeatures.Add(new Feature("GSR stdev", (data, startTime, endTime) => StandardDeviation(GeneralDataSlice(data, startTime, endTime), GSRValueAccessor)));
            GSRArousalOptimizationFeatures.Add(new Feature("GSR Min", (data, startTime, endTime) => Min(GeneralDataSlice(data, startTime, endTime), GSRValueAccessor)));
            GSRArousalOptimizationFeatures.Add(new Feature("GSR Max", (data, startTime, endTime) => Max(GeneralDataSlice(data, startTime, endTime), GSRValueAccessor)));
        }
        ...
        static void PopulateFACE()
        {
            ...
            {
                int l = i;
                FACEValenceOptimizationFeatures.Add(new Feature("Face Mean " + meanFaceLeftSide[l] + " & " + meanFaceRightSide[l], (data, startTime, endTime) => FaceMean(GeneralDataSlice(data, startTime, endTime),
            ...
            for (int j = 0; j < sdFaceLeftSide.Count; j++)
            {
                ...
                FACEValenceOptimizationFeatures.Add(new Feature("Face SD " + sdFaceLeftSide[k] + " & " + sdFaceRightSide[k],
                    (data, startTime, endTime) => FaceStandardDeviation(GeneralDataSlice(data, startTime, endTime),
            ...
            //Arousal
            FACEArousalOptimizationFeatures.Add(new Feature("Face Mean 11 & 12 ", (data, startTime, endTime) => FaceMean(GeneralDataSlice(data, startTime, endTime),
