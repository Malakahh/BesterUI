...
namespace Classification_App
{
    static class AnomaliSerializer
    {
        ...
        public static void SavePathAnomalis(List<OneClassFV> anomalis, string path, int stepSize, string name)
        {
            if (!Directory.Exists(path + "/Anomalis"))
            {
                Directory.CreateDirectory(path + "/Anomalis");
        ...
        public static void SavePathEvents(List<Events> events, string path, string name)
        {
            if (!Directory.Exists(path + "/Events"))
            {
                Directory.CreateDirectory(path + "/Events");
